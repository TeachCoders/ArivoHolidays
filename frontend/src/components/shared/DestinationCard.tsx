  ...
  return (
    ...
    >
      {image ? (
        <Image
          src={image}
          alt={`${title} Tour Packages & Sightseeing | Arivo Holidayss`}
          fill
        ...
        <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-[#1C1C1C] via-[#243b3b] to-[#1C1C1C] flex items-center justify-center">
          <Image src="/logo.png" alt="Arivo Holidayss" width={90} height={90} className="opacity-35 object-contain filter drop-shadow-md brightness-200" style={{ width: "auto", height: "auto" }} />
        </div>
      )}
