  ...
  const defaultFaqs = [
    {
      ...
      answer: `Every Arivo Holidayss package can be tailored to your preferences. Simply fill out our quick enquiry form or tap WhatsApp to connect with a dedicated travel specialist. We can adjust hotel tiers, duration, private vehicle options, sightseeing pace, and special inclusions within 15 minutes.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Absolutely. From the moment you land or reach your first destination, a personal Arivo Holidayss trip executive is assigned to your booking. You will have a dedicated contact for immediate assistance with hotel check-ins, local recommendations, driver coordination, or emergency support.`,
    },
    {
