          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center overflow-hidden shadow-lg">
                <img src="/logo.png" alt="Arivo Holiday" className="w-full h-full object-contain" />
              </div>             
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-slate-50 p-6">
        <div className="w-full max-w-md">
          ...
          <p className="text-center text-xs text-slate-400 mt-6">
            &copy; {new Date().getFullYear()} {process.env.NEXT_PUBLIC_BRAND_NAME || "Arivo Holiday"}. All rights reserved.
          </p>
        </div>
      </div>
    </div>
