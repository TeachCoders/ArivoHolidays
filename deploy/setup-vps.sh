...
# ── EDIT THIS ──
REPO_URL="${REPO_URL:-}"            # e.g. git@github.com:you/arivo.git (private → SSH URL)
...
if [ ! -f /root/.ssh/id_ed25519 ]; then
  ssh-keygen -t ed25519 -C "arivo-vps-deploy" -N "" -f /root/.ssh/id_ed25519 >/dev/null 2>&1
...
---------------------------------------------------------------
  ...
  GitHub me jaao:
   ...
   → Title: "arivo-vps"   Key: (upar wali paste karo)
...
echo "   2) Deploy:  bash /opt/arivo/app/deploy/deploy-app.sh"
echo "==============================================================="