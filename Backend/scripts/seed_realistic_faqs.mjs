...
const faqs = [
  {
    ...
    keywords: ["cancel", "cancellation", "refund", "wapas", "paise", "policy", "return"],
    answer: "Hamare cancellation policy ke hisaab se:\n• 30+ din pehle cancel karein → 90% refund\n• 15-29 din pehle → 50% refund\n• 7-14 din pehle → 25% refund\n• 7 din se kam → No refund\n\nAur jankari ke liye humare expert se baat karein.",
    sortOrder: 1,
  },
  {
    question: "kya package mein hotel included hai?",
    keywords: ["hotel", "stay", "accommodation", "raat", "room", "lodge", "resort", "included", "include"],
    answer: "Haan! Hamare tour packages mein hotel stay included hoti hai. Aap apni budget ke hisaab se choose kar sakte hain:\n• Budget: 3-star hotels\n• Mid-range: 4-star hotels\n• Luxury: 5-star resorts\n\nSaare hotels verified aur tourist-friendly hain.",
    sortOrder: 2,
  },
  {
    question: "kya flight ticket bhi milega?",
    keywords: ["flight", "ticket", "aeroplane", "hawai", "air", "fly", "plane", "airfare"],
  ...
  },
  {
    ...
    keywords: ["group", "discount", "offer", "group booking", "sab saath", "friends group", "bulk"],
  ...
  },
  {
    ...
    keywords: ["advance booking", "kitne din", "book karna", "advance", "early", "confirm", "booking"],
    answer: "Best prices aur availability ke liye:\n• International trips: 45-60 din pehle\n• Domestic trips: 15-30 din pehle\n• Peak season (Dec-Jan, Summer): 2-3 mahine pehle\n\nLast minute booking bhi hoti hai but limited options aur thoda zyada cost. Abhi book karein aur best deal paayein!",
    sortOrder: 7,
  },
  {
    question: "visa mein help milegi?",
    keywords: ["visa", "passport", "document", "permission", "foreign", "abroad", "international"],
  ...
  },
  {
    ...
    keywords: ["payment", "pay", "paisa", "online payment", "UPI", "EMI", "installment", "how to pay"],
  ...
  },
  {
    ...
    keywords: ["customize", "custom", "apne hisaab", "change", "modify", "itinerary", "plan change", "special"],
  ...
  },
  {
    ...
    keywords: ["insurance", "bima", "safety", "medical", "emergency", "accident", "coverage"],
    answer: "Haan! Hamare packages ke saath optional travel insurance available hai jo cover karta hai:\n🏥 Medical emergency\n✈️ Flight cancellation\n🧳 Baggage loss\n🚑 Emergency evacuation\n\nInternational trips ke liye travel insurance highly recommended hai. Humare expert se insurance details poochh sakte hain.",
    sortOrder: 11,
  },
  {
    question: "kya solo travel ke liye package hai?",
    keywords: ["solo", "akela", "alone", "single", "ek banda", "solo travel", "solo trip"],
