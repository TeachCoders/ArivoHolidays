...
*All services are lightweight wrappers around Prisma client calls and include error handling, logging (via `utils/logger.js`), and optional webhook/Telegram notifications where indicated.*
